 ...
 * @see https://developers.facebook.com/docs/whatsapp/guides/interactive-messages/#reply-buttons
 */
...
/**
 * Maximum length of button ID (used for webhook callbacks)
 */
...
/**
 * Maximum length of the list button text (the button that opens the list)
 */
 ...
 * This accounts for clock drift, network latency, and processing delays.
 */
...
export const INTERACTIVE_MESSAGE_ERRORS = {
  ...
  DUPLICATE_ROW_ID:
    'Row IDs must be unique within the entire message (across all sections).',
...
export function validateListMessage(
  ...
  sections?.forEach((section, sectionIndex) => {
    // Validate section title (optional but if present, has length limit)
    ...
    // Validate row count per section

/**
 * InvitationEmailQueue Construct
 *
 * Creates an SQS queue for invitation email delivery.
...
export interface InvitationEmailQueueProps {
  /**
...
export class InvitationEmailQueue extends Construct {
  ...
  constructor(
    scope: Construct,
    id: string,
    props: InvitationEmailQueueProps = {},
  ) {
    super(scope, id);

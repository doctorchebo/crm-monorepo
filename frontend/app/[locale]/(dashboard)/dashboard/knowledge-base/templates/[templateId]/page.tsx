...
import { useRouter, useParams } from "next/navigation"; // useParams is correct for app router
            ...
            if (isNew) {
                ...
                for (let i = 0; i < currentFields.length; i++) {
                    ...
                    if (field.id) {
                        ...
                        updates.push(knowledgeBaseApi.updateField(templateId, field.id, fieldData));
                    } else {
                        // Create
                        updates.push(knowledgeBaseApi.addField(templateId, {
                ...
                const deleteOperations: { fieldId: string; fieldName: string; promise: Promise<void> }[] = [];
                ...
                if (deleteOperations.length > 0) {
                    ...
                    deleteResults.forEach((result, index) => {
                        if (result.status === 'rejected') {
                            ...
                            const errorMessage = result.reason?.message || t("errors.deleteFieldUnknown");
                            ...
                            if (errorMessage.includes('Cannot delete field that has data')) {
                                ...
                                errors.push(t("errors.deleteFieldFailed", { field: fieldName, error: errorMessage }));
                            }
                        }
                    });
                }
            ...
            <div className="flex flex-col gap-4">
                <Breadcrumb>
                    <BreadcrumbList>
                        ...
                        <BreadcrumbItem>
                            <BreadcrumbPage>
                                {isNew ? t("breadcrumbs.new") : (template?.displayName || t("breadcrumbs.edit"))}
                            </BreadcrumbPage>
                        </BreadcrumbItem>
                    </BreadcrumbList>
                </Breadcrumb>
                ...
                <div className="flex items-center justify-between">
                    <div className="flex items-center gap-4">
                        ...
                        <h1 className="text-2xl font-bold tracking-tight">
                            {isNew ? t("title.new") : t("title.edit", { name: template?.displayName })}
                        </h1>
                    </div>
                ...
                <form className="space-y-8">
                    <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
                        ...
                        <div className="space-y-6">
                            ...
                            <TemplateForm isEditMode={!isNew} template={template || undefined} />
                        </div>
                    </div>
                </form>
            </Form>

...
export function Pagination({
    ...
    return (
        ...
        >
            {/* Page Size Selector */}
            {!compact && onPageSizeChange && pageSize && (
            ...
            {/* Navigation Controls */}
            <div className={`flex items-center gap-2 lg:gap-6 order-1 sm:order-2 w-full sm:w-auto ${compact ? 'justify-center' : 'justify-between sm:justify-end'}`}>
                {!compact && (
                    <span className="text-sm text-muted-foreground whitespace-nowrap">{pageText}</span>
                )}
